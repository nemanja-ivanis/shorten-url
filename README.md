...
This will migrate all tables, and seed 1 test user and 10 random urls(you can register a new user too).
...
I have prepared a couple of Unit tests which you can run `php artisan test`.
